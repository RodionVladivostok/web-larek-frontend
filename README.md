...
- 'basket:success' - событие срабатывает после клика по кнопке "Оплатить" в модальном окне с контактной информацией, приводит к рендеру модального окна успешного оформлени заказа, очистке корзины и обнулению счетчика на кнопке-иконке "Корзина" на главной странице;
